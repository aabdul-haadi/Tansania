              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white/60 font-bold leading-relaxed text-[10px] uppercase tracking-widest">Persönlich. Kompetent. Leidenschaftlich.</p>
                  </div>
                  <div className="space-y-3 w-full">
                    {["Maßgeschneiderte Reiseplanung", "Lokaler Support & Expertise", "Privat-Safaris mit Top-Guides", "Sicher & stressfrei buchen"].map((item, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white/60 font-bold text-sm leading-relaxed uppercase tracking-widest">Vielen Dank für Ihr Vertrauen.</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
