...
/**
 * Reusable high-density 2x2 Mosaic Conversion Hub.
 * Compacted vertical metrics and natural casing typography.
 */
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-white text-secondary p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center items-center text-center space-y-6 min-h-[300px] md:min-h-[350px] order-1 border-b md:border-b-0 border-border/40">
          <div className="space-y-6 flex flex-col items-center">
            ...
            >
              ...
              <p className="text-[11px] font-bold text-muted-foreground max-w-[300px] mx-auto leading-relaxed">
          ...
          <div className="w-full max-w-xs px-4 sm:px-0">
            <Link href="/trip-advisor">
              <Button className="w-full h-11 md:h-12 rounded-xl bg-secondary text-white hover:bg-primary font-bold text-xs border-none transition-all shadow-2xl group">
        ...
        <div className="relative aspect-square md:aspect-auto min-h-[300px] md:min-h-full overflow-hidden order-2">
          ...
          <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 flex items-center gap-3">
            ...
            <span className="text-white text-[10px] font-bold tracking-widest">Expert Field Registry</span>
          </div>
        </div>
        ...
        <div className="bg-[#FDF7F2] p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center items-center text-center space-y-6 min-h-[300px] md:min-h-[350px] order-3 md:order-4 border-t md:border-t-0 border-border/40">
          <div className="space-y-6">
            <div className="relative w-20 h-20 mx-auto">
              ...
              <div className="absolute -bottom-1 -right-1 bg-green-500 w-4 h-4 rounded-full border-2 border-white shadow-lg" />
            </div>
            <div className="space-y-2">
              <h3 className="font-headline text-xl sm:text-2xl md:text-3xl font-bold text-secondary">Direkter Kontakt</h3>
              <p className="text-[11px] font-bold text-muted-foreground leading-relaxed max-w-[280px] mx-auto">
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs px-4 sm:px-0">
            <Link href="/trip-planner">
              <Button className="w-full h-11 md:h-12 rounded-xl bg-secondary text-white hover:bg-primary font-bold text-xs border-none transition-all shadow-2xl">
                Beratung anfragen
              </Button>
            </Link>
            <a href="tel:+493022608080" className="flex items-center justify-center gap-2 text-[11px] font-bold text-secondary/60 hover:text-primary transition-colors py-1">
        ...
        <div className="relative aspect-square md:aspect-auto min-h-[300px] md:min-h-full overflow-hidden order-4 md:order-3 border-t border-border/40">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6 md:p-10 text-center">
            <div className="p-6 sm:p-8 md:p-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-[2.5rem] w-[85%] max-w-[320px] shadow-2xl flex flex-col items-center justify-center text-center">
              <p className="text-white font-headline text-base sm:text-xl md:text-2xl tracking-tight leading-tight">
