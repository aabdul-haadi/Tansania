  ...
  return (
    <footer className="relative bg-[#0a0a0a] text-white pt-20 pb-12 overflow-hidden border-t border-white/5 font-bold">
      <div className="container relative z-10 mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          <div className="flex flex-col gap-6">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <span className="font-headline font-bold text-[10px] md:text-xs text-primary leading-tight whitespace-nowrap tracking-tighter">
                Tansania Reiseabenteuer
              </span>
            </Link>
            <p className="text-white/60 leading-relaxed font-bold text-sm tracking-tight">
              Ihr Experte für exklusive Safari-Erlebnisse und Traumurlaube in Tansania und Sansibar.
            </p>
          </div>
          
          <div>
            <h4 className="text-white font-bold text-[10px] tracking-[0.4em] mb-8 block">Über uns</h4>
            <ul className="flex flex-col gap-4 text-[10px] font-black tracking-widest text-white/50">
          ...
          <div>
            <h4 className="text-white font-bold text-[10px] tracking-[0.4em] mb-8 block">Entdecken & Recht</h4>
            <ul className="flex flex-col gap-4 text-[10px] font-black tracking-widest text-white/50">
          ...
          <div className="space-y-8">
            <h4 className="text-white font-bold text-[10px] tracking-[0.4em] mb-6 block font-headline">Kontakt Berlin</h4>
            <ul className="flex flex-col gap-5 text-[10px] font-black tracking-widest text-white/70">
        ...
        <div className="mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] text-white/20 tracking-[0.2em] font-bold">
