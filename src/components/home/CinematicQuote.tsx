...
export function CinematicQuote() {
  return (
    <section className="relative min-h-[30vh] md:min-h-[40vh] flex items-center justify-center overflow-hidden py-12 md:py-16 px-4 bg-[#0a0a0a]">
      ...
      <div className="container relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <h2 className="font-headline text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight uppercase tracking-tighter">
