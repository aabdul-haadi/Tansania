...
export default function LoveOnSafariPage() {
  ...
  return (
    <div className="bg-[#fdfcfb] min-h-screen font-normal">
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="text-muted-foreground text-sm md:text-lg leading-relaxed font-normal max-w-4xl mx-auto mb-6 md:mb-8"
          >
      ...
      <section className="py-12 md:py-20 bg-[#fdfcfb] border-t border-border/40 overflow-hidden">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="relative aspect-square md:aspect-[16/9] min-h-[450px] md:min-h-[800px] lg:min-h-[700px] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border border-border/40 bg-secondary group">
            <Image 
            ...
            <div className="absolute top-6 left-6 md:top-10 md:left-12 space-y-2 z-30">
              <motion.div 
                ...
                className="bg-[#7a1818] text-white px-5 py-3 md:px-7 md:py-3.5 shadow-2xl rounded-sm w-fit hidden md:block"
              >
              ...
              <motion.div 
                ...
                whileInView={{ x: 0, opacity: 1 }}
                transition={{ delay: 0.1 }}
                className="bg-[#e3510d] text-white px-5 py-3 md:px-7 md:py-3.5 shadow-xl rounded-sm flex items-center gap-3 w-fit"
              >
            ...
            <div className="bg-white p-6 sm:p-8 rounded-[2rem] shadow-xl border border-border/40 space-y-6">
              ...
              <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <Link href="/trip-planner" className="w-full">
                  <Button className="w-full rounded-none h-14 bg-[#e3510d] text-white font-black text-[11px] uppercase tracking-widest border-none shadow-xl">JETZT ANFRAGEN</Button>
                </Link>
              </div>
            </div>
          </div>
      ...
      {/* 04 EXPERIENCE AUDIT: WHAT MAKES IT SPECIAL */}
