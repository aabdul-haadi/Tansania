      ...
      <section className="py-12 md:py-24 bg-[#fdfcfb] border-t border-border/40 overflow-hidden">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="relative aspect-[16/9] min-h-[600px] md:min-h-[650px] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border border-border/40 bg-secondary group">
            ...
            {/* Overlays (Left Top) */}
            <div className="absolute top-6 left-6 md:top-10 md:left-12 space-y-3 z-30">
              <motion.div 
                initial={{ x: -30, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
                className="bg-[#7a1818] text-white px-6 py-4 md:px-10 md:py-5 shadow-2xl rounded-sm w-fit"
              >
                <h3 className="font-headline font-black text-xs md:text-2xl tracking-widest leading-none uppercase">
