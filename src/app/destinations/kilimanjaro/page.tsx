    ...
    <div className="bg-[#fdfcfb] min-h-screen">
      ...
      <section className="relative h-[65vh] md:h-[80vh] flex items-center justify-center overflow-hidden bg-secondary">
        ...
        <div className="container relative z-20 mx-auto px-4 text-center">
          ...
          >
            <h1 className="font-headline text-white leading-none whitespace-nowrap text-2xl sm:text-4xl md:text-6xl lg:text-7xl uppercase">
              Kilimandscharo Besteigung
            </h1>
            <p className="max-w-2xl mx-auto text-white/90 font-bold text-[10px] md:text-sm uppercase tracking-widest mt-6 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20 items-center">
          ...
          >
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 text-primary font-bold text-[10px] uppercase">
                <Mountain className="w-4 h-4" /> Expeditions-Registry
              </div>
              <h2 className="font-headline text-secondary text-2xl md:text-4xl lg:text-5xl font-normal leading-tight uppercase">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="flex items-start gap-4 p-6 bg-white rounded-2xl border border-border shadow-sm group hover:border-primary transition-all">
                ...
                <div className="space-y-1">
                  <h4 className="font-bold text-xs text-secondary uppercase">Sicherheits-Fokus</h4>
                  <p className="text-[10px] text-muted-foreground font-bold uppercase leading-relaxed">Tägliche Gesundheitschecks & modernste Ausrüstung.</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white rounded-2xl border border-border shadow-sm group hover:border-primary transition-all">
                <Users className="w-6 h-6 text-primary shrink-0" />
                <div className="space-y-1">
                  <h4 className="font-bold text-xs text-secondary uppercase">Profi-Guides</h4>
                  <p className="text-[10px] text-muted-foreground font-bold uppercase leading-relaxed">Staatlich geprüft mit über 100 Gipfelstürmen.</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-12 md:py-24 bg-[#f8f8f8] relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 md:mb-24 gap-8">
            <div className="space-y-4">
              <span className="text-primary font-bold uppercase text-[10px]">Registry Protocol</span>
              <h2 className="font-headline text-3xl md:text-6xl font-normal text-secondary uppercase">
                Die legendären <span className="text-primary font-bold">Routen</span>
              </h2>
            </div>
            <p className="text-muted-foreground font-bold text-sm md:text-base uppercase max-w-xs border-l-2 border-primary/20 pl-6 leading-relaxed">
                ...
                <div className="bg-white rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 shadow-sm border border-border/50 hover:shadow-2xl transition-all duration-700 flex flex-col justify-between h-full relative overflow-hidden">
                  ...
                  <div className="space-y-8 relative z-10">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline" className="rounded-lg border-primary/20 text-primary px-3 py-1 font-black text-[8px] uppercase">
                        Official Path
                      </Badge>
                    </div>

                    <div className="space-y-3">
                      <h3 className="font-headline text-2xl md:text-4xl font-normal text-secondary uppercase group-hover:text-primary transition-colors">
                        {route.name}
                      </h3>
                      <p className="text-sm leading-relaxed text-muted-foreground font-normal uppercase opacity-80">
                        {route.desc}
                      </p>
                    </div>
                  ...
                  <div className="pt-10">
                    <Link href="/contact" className="block">
                      <Button variant="outline" className="w-full rounded-xl h-12 text-[9px] font-black uppercase group-hover:bg-secondary group-hover:text-white transition-all border-muted shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-8">
            {[
              ...
              >
                ...
                <div>
                  <p className="text-[9px] uppercase font-bold text-primary mb-1">{fact.label}</p>
                  <p className="font-bold text-lg md:text-xl text-secondary uppercase leading-none">{fact.val}</p>
                  <p className="text-[9px] text-muted-foreground uppercase font-bold mt-1">{fact.sub}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-12 md:py-24 container mx-auto px-4 max-w-7xl scroll-mt-20">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-20 gap-6">
          <div className="max-w-2xl">
            <span className="text-primary font-bold uppercase text-[10px] mb-2 block">Expeditions Portfolio</span>
            <h2 className="font-headline text-3xl md:text-6xl font-normal text-secondary uppercase">Wählen Sie Ihre <span className="text-primary font-bold">Gipfeltour</span></h2>
          </div>
        </div>
        ...
        {isLoading ? (
          <div className="py-20 text-center space-y-4">
            ...
            <p className="text-[10px] font-bold uppercase text-muted-foreground animate-pulse">Syncing Catalog...</p>
          </div>
        ) : (
      ...
      <section className="py-12 md:py-24 bg-[#FDF7F2] border-y border-border/40 scroll-mt-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12 md:mb-20 space-y-4">
            <h2 className="font-headline text-3xl md:text-6xl font-normal text-secondary uppercase">Häufig gestellte Fragen</h2>
            <p className="text-muted-foreground uppercase font-bold text-[10px]">Wissenswertes zur Expedition</p>
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, i) => (
              <AccordionItem key={i} value={`item-${i}`} className="border-none bg-white rounded-2xl px-6 md:px-10 shadow-sm border border-transparent hover:border-border transition-all">
                <AccordionTrigger className="font-normal text-base md:text-xl py-6 hover:no-underline text-left text-secondary transition-colors uppercase">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground text-sm md:text-base leading-relaxed font-normal pb-8 uppercase opacity-80 text-left">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
