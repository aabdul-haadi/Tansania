...
const packages = [
  {
    ...
    tag: 'Bestseller',
    cat: 'SAFARI & SANSIBAR',
    title: '15 Tage Safari & Sansibar Rundreise',
    duration: '15 Tage Erlebnis',
  ...
  },
  {
    ...
    tag: 'All-Inclusive',
    cat: 'SAFARI & SANSIBAR',
    title: '13 Tage Safari & Sansibar Abenteuer',
    duration: '13 Tage All-Inclusive',
    accommodation: 'Komfortable Lodges & Resorts',
  ...
  },
  {
    ...
    tag: 'Nur Insel',
    cat: 'SANSIBAR',
    title: '7 Tage Sansibar – Tropisches Flair',
    duration: '7 Tage Strandurlaub',
    accommodation: 'Strandresorts & Hotels',
    groupSize: 'Max. 10 Teilnehmer',
    price: '2.699',
      ...
      <section className="py-16 md:py-24 container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
          <div className="max-w-xl">
            ...
            <h2 className="font-headline text-3xl md:text-6xl font-bold leading-tight">Unsere Sansibar & <br /><span className="text-primary italic">Safari Abenteuer</span></h2>
          </div>
