          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[500px] md:min-h-[650px]">
            ...
            <div className="lg:col-span-4 p-6 md:p-10 bg-muted/20 border-b lg:border-b-0 lg:border-r border-border/50 flex flex-col justify-between">
              <div className="space-y-6">
                <div>
                  <span className="text-primary font-black uppercase tracking-[0.4em] text-[9px] md:text-[10px] block mb-2">Explorer Map</span>
            ...
            <div className="lg:col-span-8 relative aspect-video lg:aspect-auto">
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-xl border border-white">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-secondary">Zentrum der Migration</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="space-y-8">
              <div>
                <span className="text-primary font-black uppercase tracking-[0.4em] text-[9px] block mb-2">Peak Safari Zeit</span>
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="flex items-center gap-5 p-6 bg-white rounded-2xl border border-border shadow-sm group hover:border-primary transition-all duration-500">
                  ...
                  <div>
                    <p className="font-black text-base uppercase text-secondary">Juli – Oktober</p>
                    <p className="text-[9px] text-muted-foreground font-black uppercase tracking-widest mt-0.5">Trockenzeit & Beste Sichtungen</p>
                  </div>
                </div>
                <div className="flex items-center gap-5 p-6 bg-white rounded-2xl border border-border shadow-sm group hover:border-primary transition-all duration-500">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-muted-foreground font-black uppercase tracking-widest mt-0.5">Grüne Saison & Vogelvielfalt</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <h4 className="text-white font-black text-lg uppercase leading-tight mb-3 text-white">Tipp der Guides</h4>
