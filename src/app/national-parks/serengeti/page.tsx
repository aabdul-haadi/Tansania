...
export default function SerengetiPage() {
  return (
    <div className="bg-[#fdfcfb] min-h-screen font-normal">
      {/* 01 Cinematic Hero: Reduced Height Protocol */}
      ...
      {/* 02 Narrative Context: Split Image Layout */}
            ...
            >
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <span className="text-primary font-bold text-[10px] md:text-[11px] block tracking-normal uppercase-none">
