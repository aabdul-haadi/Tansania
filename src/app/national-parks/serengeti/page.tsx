      ...
      <section className="relative h-[40vh] md:h-[55vh] w-full overflow-hidden bg-secondary">
        ...
        <div className="container relative z-10 mx-auto px-6 h-full flex flex-col items-center justify-end text-center pb-12 md:pb-16 max-w-7xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="space-y-4">
            <p className="text-white text-[11px] font-normal tracking-normal drop-shadow-lg">Das größte Naturschauspiel der Erde</p>
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              <div className="space-y-4 text-left">
                <div className="space-y-2"><div className="w-8 h-0.5 bg-primary" /><span className="text-primary font-normal text-[11px] block tracking-normal">Unesco-Weltnaturerbe seit 1952</span></div>
      ...
      <section className="relative py-12 md:py-24 overflow-hidden bg-secondary">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12 md:mb-20 space-y-4">
            ...
            <p className="text-white/80 font-normal text-[11px] md:text-sm tracking-widest max-w-xl mx-auto">Folgen Sie dem jährlichen Zyklus der Tierwanderung</p>
          </div>
      ...
      <section className="py-8 md:py-12 bg-white border-y border-border/40">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-8 md:mb-12 space-y-4">
            ...
            <h2 className="font-headline text-3xl md:text-6xl font-normal text-secondary tracking-tighter text-center">Unvergessliche <span className="text-primary">Aktivitäten</span> in der Serengeti</h2>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-primary rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-16 text-white relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl">
            ...
            <div className="relative z-10 lg:w-[60%] space-y-8 text-left">
              <div className="flex items-center gap-4"><div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-xl"><Compass className="w-6 h-6 md:w-8 md:h-8 text-white" /></div><h2 className="font-headline text-lg sm:text-2xl md:text-5xl font-normal tracking-tighter text-white">Planen Sie Ihre perfekte Serengeti Safari</h2></div>
              <p className="text-white/80 font-normal text-[11px] md:text-base tracking-widest leading-relaxed max-w-2xl">Unsere Safari-Experten helfen Ihnen, die idealen Aktivitäten für Ihre Reisezeit und Interessen zu kombinieren. Erstellen Sie jetzt Ihr individuelles Programm.</p>
            </div>
