          ...
          <div className="space-y-10">
            <div className="space-y-6 text-left">
              <div className="space-y-2">
                ...
                <span className="text-primary font-bold text-[10px] block tracking-widest">Kompakte Vielfalt auf engstem Raum</span>
              </div>
          ...
          <div className="bg-primary rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-16 text-white relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl text-center lg:text-left">
            ...
            <div className="relative z-10 lg:w-[60%] space-y-6">
              <div className="flex flex-col lg:flex-row items-center gap-4">
                ...
                <h2 className="font-headline text-2xl sm:text-3xl md:text-5xl font-normal text-white leading-tight tracking-tighter">Planen Sie Ihre perfekte Manyara Safari</h2>
              </div>
