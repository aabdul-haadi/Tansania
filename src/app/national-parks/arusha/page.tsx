        ...
        <div className="container relative z-10 mx-auto px-6 h-full flex flex-col items-center justify-end text-center pb-12 md:pb-16 max-w-7xl">
          ...
          >
            <p className="text-white text-[11px] font-bold tracking-normal drop-shadow-lg">
              Einzigartiges Erlebnis vor den Toren Arushas
            </p>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <span className="text-primary font-bold text-[11px] block tracking-normal">
                    Der vielfältigste Nationalpark Tansanias
                  </span>
                </div>
                <h2 className="font-headline text-3xl md:text-5xl font-normal text-secondary leading-tight tracking-tight">
                  Einzigartiges Naturschauspiel am Mount Meru
                </h2>
              </div>
              
              <div className="space-y-6 text-muted-foreground font-normal text-[14px] leading-[20px] text-left opacity-90">
                <p>
                  Nur wenige Kilometer von Arusha Stadt entfernt erwartet Sie ein einzigartiges Naturschauspiel. Der Arusha Nationalpark vereint drei spektakuläre Landschaften: den majestätischen Mount Meru, den Ngurdoto Krater und die sieben zauberhaften Momella Seen.
                </p>
                <p>
                  Im Gegensatz zu anderen Nationalparks Tansanias können Sie hier Wanderungen unternehmen, Kanu fahren und die Natur hautnah erleben. Ideal für Reisende, die sowohl Wildlife als auch spektakuläre Landschaften suchen.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="relative">
            ...
            >
              <Image 
                ...
                alt="Landschaft im Arusha Nationalpark" 
                fill 
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16 space-y-6">
            ...
            <h2 className="font-headline text-3xl md:text-6xl font-normal text-secondary tracking-tight">
              Entdecken Sie Tansania <span className="text-primary">auf der Karte</span>
            </h2>
          </div>
          ...
          <div className="relative rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl bg-muted border border-border/50 aspect-video md:aspect-[21/9] mb-10 md:mb-16 group">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d255141.0565814515!2d36.63467655!3d-3.23307525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1837090885e33d07%3A0x633190d79674066b!2sArusha%20National%20Park!5e0!3m2!1sen!2stz!4v1711234567890!5m2!1sen!2stz"
              ...
              <Card className="bg-white/95 backdrop-blur-xl border border-white rounded-[2rem] p-6 shadow-2xl">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-headline text-xl font-bold text-secondary">Top Safari Ziele</h4>
                  </div>
                  <div className="space-y-4">
                    {[
                      { t: "Serengeti Nationalpark", d: "Große Tierwanderung" },
                      { t: "Ngorongoro Krater", d: "UNESCO Weltnaturerbe" },
                      { t: "Kilimanjaro", d: "Afrikas höchster Berg" },
                      { t: "Sansibar", d: "Gewürzinsel & Traumstrände" }
                    ].map((h, i) => (
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-8 md:mb-12 space-y-4">
            ...
            <h2 className="font-headline text-3xl md:text-6xl font-normal text-secondary tracking-tighter">
              Unvergessliche Aktivitäten im <span className="text-primary">Arusha Park</span>
            </h2>
            <p className="text-muted-foreground text-sm font-bold max-w-2xl mx-auto leading-relaxed">
              Erleben Sie den Arusha Nationalpark auf einzigartige Weise – von geführten Wanderungen über Kanufahrten bis hin zu spannenden Pirschfahrten.
            </p>
          </div>
          ...
          <div className="bg-primary rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-16 text-white relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl">
            ...
            <div className="relative z-10 lg:w-[60%] space-y-8 text-left">
              ...
              <p className="text-white/80 font-bold text-[11px] md:text-base tracking-widest leading-relaxed max-w-2xl">
                Starten Sie Ihr Abenteuer direkt vor den Toren Arushas. Wir entwerfen Ihre individuelle Tour durch Bergwälder und Kraterlandschaften.
              </p>
            </div>
