...
export default function ArushaParkPage() {
  ...
  return (
    <div className="bg-[#fdfcfb] min-h-screen">
      ...
      <section className="relative h-[65vh] md:h-[80vh] w-full flex items-center justify-center overflow-hidden bg-secondary">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="space-y-6">
            <Badge className="bg-primary text-white border-none font-black text-[10px] uppercase tracking-[0.4em] px-6 py-2 shadow-2xl mb-4">Das Tor zur Wildnis</Badge>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[500px] md:min-h-[650px]">
            ...
            <div className="lg:col-span-4 p-6 md:p-10 bg-muted/20 border-b lg:border-b-0 lg:border-r border-border/50 flex flex-col justify-between">
              <div className="space-y-6">
                <div>
                  <span className="text-primary font-black uppercase tracking-[0.4em] text-[9px] md:text-[10px] block mb-2">Park Navigator</span>
            ...
            <div className="lg:col-span-8 relative aspect-video lg:aspect-auto">
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-xl border border-white">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-secondary">Live Park-Daten</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Modern Activity Carousel (Mobile-First) */}
      <section className="py-12 md:py-24 bg-white border-y border-border/50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-end justify-between mb-10 md:mb-16 gap-6">
            <div>
              <span className="text-primary font-black uppercase tracking-[0.4em] text-[9px] md:text-[10px] mb-2 block">Die Erlebnisse</span>
                  ...
                  <div className="bg-[#fdfcfb] rounded-[2.5rem] overflow-hidden shadow-lg border border-border/50 group h-full flex flex-col hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-5 left-5">
                        <Badge className="bg-secondary text-white border-none font-black text-[8px] uppercase tracking-widest px-3 py-1 shadow-lg">{act.level}</Badge>
                      </div>
                    </div>
                    <div className="p-8 space-y-5 flex-grow flex flex-col justify-between">
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em]">{act.time}</span>
                        </div>
                      ...
                      <Link href="/contact" className="inline-flex items-center gap-3 text-[9px] font-black uppercase tracking-[0.3em] text-primary hover:translate-x-1 transition-transform pt-5 border-t border-border/50 group/btn">
      ...
      {/* Climate & Expert Insights (High Contrast Light Theme) */}
      <section className="py-16 md:py-24 bg-[#fdfcfb] relative overflow-hidden">
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="space-y-8">
              <div>
                <span className="text-primary font-black uppercase tracking-[0.4em] text-[9px] block mb-2">Klima & Planung</span>
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="flex items-center gap-5 p-6 bg-white rounded-2xl border border-border shadow-sm group hover:border-primary transition-all duration-500">
                  ...
                  <div>
                    <p className="font-black text-base uppercase text-secondary">Juni – Oktober</p>
                    <p className="text-[9px] text-muted-foreground font-black uppercase tracking-widest mt-0.5">Trockenzeit & Beste Fernsicht</p>
                  </div>
                </div>
                <div className="flex items-center gap-5 p-6 bg-white rounded-2xl border border-border shadow-sm group hover:border-primary transition-all duration-500">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <p className="font-black text-base uppercase text-secondary">November – Mai</p>
                    <p className="text-[9px] text-muted-foreground font-black uppercase tracking-widest mt-0.5">Grüne Saison & Vogelwelt</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <h4 className="text-white font-black text-lg uppercase leading-tight mb-3 text-white">Geheimtipp der Guides</h4>
                <p className="text-white font-bold text-[10px] uppercase tracking-widest opacity-90 leading-relaxed text-white">
