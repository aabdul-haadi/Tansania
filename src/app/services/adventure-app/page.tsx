      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="font-headline text-4xl md:text-6xl font-bold mb-6 leading-tight">Your Safari <br /><span className="text-primary italic">In Your Pocket</span></h1>
            ...
            <div className="relative w-full max-w-[300px] aspect-[9/19] bg-[#0a0a0a] rounded-[3rem] p-3 shadow-2xl border-4 border-muted">
              ...
              <div className="w-full h-full bg-secondary rounded-[2.5rem] overflow-hidden relative">
                ...
                <div className="p-6 pt-10">
                  ...
                  <h3 className="text-white text-2xl font-headline font-bold mb-4">Great <br />Migration</h3>
                  <div className="space-y-3">
                    <div className="h-20 w-full bg-white/5 rounded-2xl border border-white/10 p-4">
                      ...
                      <p className="text-white font-bold text-sm">Mara River Crossing</p>
                    </div>
                    <div className="h-32 w-full bg-primary/20 rounded-2xl border border-primary/20 p-4">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-[10px] text-primary font-bold">Active Alert</span>
                        <Share2 className="w-3 h-3 text-primary" />
                      </div>
                      <p className="text-white text-xs font-light leading-tight">Lion pride spotted 2km North of your current location. Track path updated.</p>
                    </div>
                  </div>
                </div>
              </div>
