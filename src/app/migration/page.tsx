  ...
  return (
    <div className="bg-[#fdfcfb] min-h-screen font-normal">
      ...
      <section className="relative h-[70vh] md:h-[85vh] w-full flex flex-col items-center justify-center overflow-hidden bg-secondary">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-transparent to-[#fdfcfb]" />
        ...
        <div className="container relative z-10 mx-auto px-6 h-full flex flex-col justify-center items-center pt-32 md:pt-40 text-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="max-w-2xl mx-auto text-white/90 font-normal text-sm md:text-xl leading-relaxed opacity-90 tracking-wide">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Button variant="glass" size="lg" className="w-full sm:w-auto h-12 md:h-14 px-10 rounded-xl font-bold text-xs">
