...
export default function SafarisPage() {
  ...
  return (
    <div className="bg-[#fdfcfb] min-h-screen font-normal">
      ...
      {/* Expertise Segment */}
      <section className="py-12 md:py-16 bg-white border-t border-border/40 overflow-hidden">
            ...
            {reviews.map((r, i) => (
              <div key={i} className="p-8 bg-[#fdfcfb] rounded-[2rem] border border-border/50 shadow-sm space-y-6 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <p className="text-[14px] leading-[20px] text-secondary font-medium tracking-tight">"{r.text}"</p>
                </div>
