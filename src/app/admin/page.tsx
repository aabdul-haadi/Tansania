    ...
    try {
      const allPackages = [
        ...
        { 
          ...
          groupSize: 'Maximal 8 Teilnehmer',
        ...
        { 
          ...
          slug: '13-day-safari-zanzibar', 
          category: 'SAFARI & SANSIBAR', 
          durationDays: 13, 
          startingPrice: 3699, 
          accommodation: 'Komfort Lodges & Resorts',
          groupSize: 'Maximal 10 Teilnehmer',
        ...
        { 
          ...
          slug: '13-day-honeymoon', 
          category: 'FLITTERWOCHEN', 
          tag: 'Romantik', 
          durationDays: 13, 
          startingPrice: 3899, 
          accommodation: 'Premium Lodges & Villen',
          groupSize: 'Maximal 6 Teilnehmer',
          highlights: ['Champagner Sunset', 'Private Pirschfahrten', 'Luxuslodges & Villen', 'Sansibar Stranddinner', 'Heißluftballon Serengeti'], 
        ...
        { 
          ...
          groupSize: 'Maximal 8 Teilnehmer',
          highlights: ['Safari in Nationalparks', 'Kilimandscharo hautnah', 'Big Five Erlebnisse', 'Sansibar Strand & Kultur', 'Abenteuer & Erholung'], 
          imageUrl: 'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?q=80&w=800' 
        },
        
        // KILIMANJARO
        { 
          id: '13-day-kili-kombi', 
          title: '13 Tage Kilimandscharo & Safari Kombi', 
          slug: '13-day-kili-kombi', 
          ...
          groupSize: 'Maximal 8 Teilnehmer',
          highlights: ['Afrikas Dach erklimmen', 'Big Five hautnah', 'Sansibars Strände', 'Naturpanoramen'], 
          imageUrl: 'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?q=80&w=800' 
        },
        { 
          id: '8-day-marangu', 
          ...
          groupSize: 'Maximal 10 Teilnehmer',
          highlights: ['Hütten statt Zelte', 'Sonnenaufgang am Krater', 'Dschungel bis Eisfelder', 'Coca-Cola Route'], 
          imageUrl: 'https://images.unsplash.com/photo-1650361109293-909990990901?q=80&w=800' 
        },
        { 
          id: '9-day-machame', 
          ...
          groupSize: 'Maximal 8 Teilnehmer',
          highlights: ['Whiskey Route erleben', 'Optimal akklimatisiert', 'Hohe Erfolgsquote', 'Spirituelles Abenteuer'], 
        ...
        { 
          ...
          durationDays: 10, 
          startingPrice: 3599, 
          accommodation: 'Premium Zeltcamps',
          groupSize: 'Maximal 6 Teilnehmer',
          highlights: ['Westseite Kili', 'Wenig begangene Route', 'Höchste Erfolgsquote', 'Premium Ausrüstung'], 
          imageUrl: 'https://images.unsplash.com/photo-1511860810434-a92f84c6f01e?q=80&w=800' 
        },
        { 
          id: '8-day-rongai', 
          ...
          durationDays: 8, 
          startingPrice: 2999, 
          accommodation: 'Zeltcamps mit Vollpension',
          groupSize: 'Maximal 8 Teilnehmer',
          highlights: ['Nordseite Kili', 'Abgeschieden & ruhig', 'Tierbeobachtungen', 'Familienfreundlich'], 
          imageUrl: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=800' 
        },
        { 
          id: '5-day-mount-meru', 
          ...
          durationDays: 5, 
          startingPrice: 2699, 
          accommodation: 'Berghütten & Zeltcamps',
          groupSize: 'Maximal 8 Teilnehmer',
          highlights: ['Afrikas 2. höchster Gipfel', 'Perfekte Vorbereitung', 'Wildtiere hautnah', 'Ideale Akklimatisierung'], 
          imageUrl: 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?q=80&w=800' 
        },
      ];
