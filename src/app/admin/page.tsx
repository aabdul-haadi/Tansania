...
export default function AdminDashboard() {
  ...
  const handleSeedData = async () => {
    ...
    try {
      const allPackages = [
        // SAFARIS
        { id: '15-day-safari-zanzibar', title: '15 Tage Safari und Sansibar Komplettpaket', slug: '15-day-safari-zanzibar', category: 'SAFARI & SANSIBAR', tag: 'Meistverkauft', durationDays: 15, startingPrice: 5399, highlights: ['Top Nationalparks Safari', 'Massai Dorfbesuch', 'Familienfreundliche Unterkünfte', 'Sansibar Strände & Tauchen', 'Gewürztour & Stone Town'], imageUrl: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=800' },
        ...
        { id: '11-day-safari-zanzibar', title: '11 Tage Safari und Sansibar Kurztrip', slug: '11-day-safari-zanzibar', category: 'SAFARI & SANSIBAR', tag: 'Kurztrip', durationDays: 11, startingPrice: 2999, highlights: ['Elefanten im Tarangire', 'Massai Kultur erleben', 'Serengeti Tiermigration', 'Ngorongoro Kraterfahrt', 'Sansibar Strände & Touren'], imageUrl: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?q=80&w=800' },
        { id: '13-day-honeymoon', title: '13 Tage Flitterwochen Rundreise Premium', slug: '13-day-honeymoon', category: 'FLITTERWOCHEN', tag: 'Romantik', durationDays: 13, startingPrice: 3899, highlights: ['Champagner Sunset', 'Private Pirschfahrten', 'Luxuslodges & Villen', 'Sansibar Stranddinner', 'Heißluftballon Serengeti'], imageUrl: 'https://images.unsplash.com/photo-1580502304784-8985b777da59?q=80&w=800' },
