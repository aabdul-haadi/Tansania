          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-center md:text-left space-y-2">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 mb-2 text-[10px] font-black uppercase tracking-[0.4em] text-primary bg-primary/5 rounded-full border border-primary/20"
              >
            ...
            <div className="flex items-center gap-6">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-secondary flex items-center justify-center shadow-2xl border border-white/5">
          ...
          <div className="lg:col-span-8 flex flex-col h-[600px] md:h-[750px] bg-white rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl border border-border/50 overflow-hidden relative">
            <div className="p-5 border-b flex items-center justify-between bg-white/90 backdrop-blur-md sticky top-0 z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-black text-[10px] uppercase tracking-widest text-secondary leading-none">Dialog Registry</h4>
                ...
                {messages.map((m, idx) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      {m.action && m.route && (
                        <Button asChild size="sm" variant="outline" className="rounded-full h-10 px-6 text-[9px] font-black uppercase tracking-[0.2em] border-primary/30 text-primary hover:bg-primary/5 group w-fit" suppressHydrationWarning>
                          <Link href={m.route}>
              ...
              >
                <div className="relative flex-grow">
                  <Input
                    ...
                    className="h-14 md:h-16 pl-6 rounded-2xl border-muted bg-[#fdfcfb] shadow-inner focus:ring-primary/20 text-sm font-bold uppercase tracking-tight"
                    suppressHydrationWarning
                  />
                </div>
                <Button 
            ...
            <Card className="rounded-[2.5rem] border-none shadow-xl overflow-hidden bg-white">
              <CardContent className="p-8 space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-headline text-base font-bold text-secondary uppercase tracking-tight leading-none">Live Status</h3>
            ...
            <div className="bg-secondary text-white p-8 rounded-[3rem] shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex items-center gap-3 text-primary">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/80">Support Hub</span>
                </div>
                ...
                <div className="pt-2 flex flex-col gap-3">
                  <Button asChild className="w-full h-14 rounded-2xl bg-primary text-white font-black text-[10px] uppercase tracking-[0.2em] shadow-xl border-none" suppressHydrationWarning>
