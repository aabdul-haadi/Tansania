...
const reviewData = [
  ...
  { name: "Maximilian K.", text: "Ich habe einen Last Minute Neujahrsurlaub gebucht und war anfangs etwas besorgt, aber alles verlief reibungslos. Der Service war hervorragend." },
  { name: "Julia B.", text: "Wer hätte gedacht, dass Neujahrsurlaub in Tansania so toll wäre? Keine Schneeflocken, dafür die Sonne und Strände von Sansibar!" },
...
export default function NewYearPage() {
  return (
    <div className="bg-[#fdfcfb] min-h-screen font-normal">
      ...
      {/* 03 Shared Package Registry Grid */}
      ...
      {/* 04 Modern Glass Discovery Sections */}
      <section className="py-8 md:py-12 bg-white border-y border-border/40">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          {/* Mobile Modern Slider: Gutter Protocol */}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              { t: "Silvester außergewöhnlich", d: "Statt Wintergrau erwartet dich Afrikas Sonne: private Safari-Erlebnisse, handverlesene Lodges und tropische Strände." }
            ].map((point, i) => (
      ...
      {/* 06 Partner Protocol: Traveler Types */}
